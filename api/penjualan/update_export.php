...
// DELETE ALL
$a = pg_fetch_array(pg_query($conn, "SELECT a.total, a.lock_date, a.invoice_number, b.uid_customer FROM invoice_header a, po_house b WHERE a.uid='$_POST[uid]' and a.uid_data=b.uid"));
$uid_akun_terima = 'dd0af3a6-ff44-6c73-3aff-2c262d89ce59';
        ...
        $sql="UPDATE keu_akun_log SET deleted_at='$waktu_sekarang' WHERE  created_at = '$a[lock_date]' and (uid_akun_efek='$a[uid_customer]' OR uid_akun_efek='$uid_akun_terima')"; 
        pg_query($conn, $sql);
        ...
        $sql= "UPDATE keu_akun_log SET saldo= (saldo - $a[total]) WHERE uid_akun='$a[uid_customer]' AND created_at > '$a[lock_date]'";
        pg_query($conn, $sql);

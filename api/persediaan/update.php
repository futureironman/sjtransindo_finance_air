...
// INPUT TRY
         ...
         $sql="INSERT INTO keu_akun_jurnal (waktu, uid_data, keterangan, id_jenis) VALUES ('$waktu', '$uid_akun_kotak', 'Penjualan', '4')";
         pg_query($conn,$sql);	    
         ...
         $sql = "INSERT INTO keu_akun_log (uid_akun, created_at, id_data, id_status, keterangan, debet, kredit, saldo,tabel,uid_akun_efek) VALUES ('$uid_akun_kotak', '$waktu', '$uid_akun_kotak', '25', '$keterangan','$total', '0', '$saldo_kredit', 'detail_barang_log','$uid_akun_terima')";
         ...
         $sql = "INSERT INTO keu_akun_log (uid_akun, created_at, id_data, id_status, keterangan, debet, kredit, saldo,tabel,uid_akun_efek) VALUES ('$uid_akun_terima', '$waktu',  '$uid_inv_header','25', '$uid_inv_header', '$total', '0', '$saldo_debet',  'invoice_header', '$uid_akun_kotak')";
         pg_query($conn, $sql);
...
$invoice_number = $a["invoice_number"];
      ...
      //   and d.uid_comodity= CAST(c.uid AS UUID)");
        ...
        //PENCATATAN DI LOG KEU AKUN KAS KECIL (BCA)
        $sql = "INSERT INTO keu_akun_log (uid_akun, created_at, id_data, id_status, keterangan, debet, kredit, saldo, keterangan_detail, tabel,uid_akun_efek) VALUES ('$uid_akun_terima', '$waktu',  '$uid_akun_kotak','25', '$keterangan', '$total', '0', '$saldo_debet', '$keterangan_detail', 'invoice_header', '$uid_customer')";
         pg_query($conn, $sql);

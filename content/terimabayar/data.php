                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover" style="width:100%" id="example">
                            ...
                            $grand_total = 0;
                            $grand_total_bayar = 0;
                            $tampil = pg_query($conn, "SELECT * from keu_pembayaran where deleted_at is NULL and id_divisi='$_SESSION[divisi]' and created_at BETWEEN '$tanggal_awal 00:00:00' AND '$tanggal_akhir 23:59:59'");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="view-terimabayar-<?= $r["uid"] ?>"><?php echo $r["no_bukti"]; ?></a></td>

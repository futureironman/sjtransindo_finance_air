...
if (empty($_SESSION['login_user'])){
	...
	if ($act=='input'){
        ...
        $id_status="11";
        $id_jenis="13";
        $nama_jenis="Pembayaran Hutang Saldo Awal";
        $kode_jenis="PL";
        ...
        //AKUN HUTANG YANG AKAN DI DIDEBETKAN
        //CEK SALDO 
        ...
        $sql="INSERT INTO keu_akun_jurnal (waktu, uid_data, keterangan, id_jenis, no_bukti, linked_table, id_divisi) VALUES ('$waktu', '$uid_transaksi_lain', '$nama_jenis', '$id_jenis', '$_POST[referensi]', 'keu_akun_transaksi_lain', '$_SESSION[divisi]') RETURNING id";
		...
		pg_query($conn, "INSERT INTO pegawai_activity_log(activity, effects_to, created_at, uid_pegawai, tabel) VALUES('insert phsa','$uid_transaksi_lain','$waktu_sekarang','$_SESSION[login_user]','keu_akun_transaksi_lain')");
        header("location: phsa");
		...
		// insert pegawai_activity_log
		pg_query($conn, "INSERT INTO pegawai_activity_log(activity, effects_to, created_at, uid_pegawai, tabel) VALUES('update phsa','$_POST[uid]','$waktu_sekarang','$_SESSION[login_user]','keu_akun_transaksi_lain')");
        header("location: phsa");
    }
		...
		// insert pegawai_activity_log
		pg_query($conn, "INSERT INTO pegawai_activity_log(activity, effects_to, created_at, uid_pegawai, tabel) VALUES('insert psha','$_GET[id]','$waktu_sekarang','$_SESSION[login_user]','keu_akun_transaksi_lain')");
        header("location: phsa");
    }
    else if($act=='cetak'){
        include "cetak.php";

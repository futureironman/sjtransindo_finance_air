...
<div class="container-fluid page__heading-container">
    <div class="page__heading d-flex align-items-center">
        <div class="flex">
            ...
            <h4 class="m-0">Edit Biaya</h4>
        </div>
    </div>
</div>

<div class="container-fluid page__container">
    <form method="POST" action="aksi-edit-biaya">
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-8 card-form__body card-body">
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input type="time" class="form-control" name="jam" required value="<?php echo $jam;?>">
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="nama_biaya" placeholder="Cth. Biaya Bensin, biaya parkir, dll" required value="<?php echo $d['nama_biaya'];?>">
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="vendor" placeholder="Cth. Pertamina, Toko Bangunan, dll" required value="<?php echo $d['vendor'];?>">
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control money" name="jumlah" placeholder="Isi nominal transaksi" required value="<?php echo formatAngka($d['jumlah']);?>">
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="referensi" placeholder="Cth. Parkir di mall, bensin premium 5L" value="<?php echo $d['keterangan'];?>">
                    </div>
                </div>
                <div class="row form-group">

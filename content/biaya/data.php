        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Beban Biaya</li>
                </ol>
            </nav>
            <h4 class="m-0">Beban Biaya</h4>
        </div>
        <a href="tambah-biaya"><button type="button" class="btn btn-info ml-3"><i class="fa fa-plus"></i> Tambah</button></a>
    </div>
</div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover" style="width:100%" id="example">
                    ...
                    <tbody>
                        <?php
                        $tampil=pg_query($conn,"SELECT a.uid, a.nomor AS nomor_transaksi, a.waktu, a.created_at, a.nama_biaya, b.nomor AS nomor_akun_asal, b.nama AS nama_akun_asal, c.nomor AS nomor_akun_tujuan, c.nama AS nama_akun_tujuan, a.jumlah, a.keterangan, d.nama AS jenis_transaksi FROM keu_akun_transaksi_lain a, keu_akun b, keu_akun c, keu_akun_transaksi_lain_jenis d WHERE a.uid_akun_kas=b.uid AND a.uid_akun_lawan=c.uid AND a.id_jenis=d.id AND a.created_at BETWEEN '$tanggal_awal 00:00:00' AND '$tanggal_akhir 23:59:59' AND a.deleted_at IS NULL AND a.id_jenis=11 ORDER BY a.created_at DESC");
                        $no=1;
                        while($r=pg_fetch_array($tampil)){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit-biaya-<?php echo $r['uid'];?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></button></a>
...
<script type="text/javascript" src="addons/js/biaya.js"></script>
<?php
break;

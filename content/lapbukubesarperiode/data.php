        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Buku Besar Periode</li>
                </ol>
            </nav>
            <h4 class="m-0">Laporan Buku Besar Periode</h4>
        </div>
    </div>
</div>
...
$(".btnCetak").click(function() {
    var id = this.id;
    window.open("cetak-lapbukubesarperiode?uid_akun=<?php echo $uid_akun;?>&tanggal_awal=<?php echo $tanggal_awal;?>&tanggal_akhir=<?php echo $tanggal_akhir;?>" + id, "popupWindow", "width=600,height=600,scrollbars=yes");
});
</script>
<?php
$d=pg_fetch_array(pg_query($conn,"SELECT nomor, nama FROM keu_akun WHERE uid='$_POST[id]'"));
?>
<form action="aksi-tambah-coa2" method="POST" enctype="multipart/form-data">
    <input type="hidden" name="uid_parent" value="<?php echo $_POST['id'];?>">
	<div class="modal-dialog modal-md a-lightSpeed">
		<div class="modal-content">
			...
			<div class="modal-body" id="form-data">
                Header Akun : <b><?php echo $d['nomor'].' '.$d['nama'];?></b>

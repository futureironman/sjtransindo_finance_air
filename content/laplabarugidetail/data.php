        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Laporan Laba Rugi Detail</li>
                </ol>
            </nav>
            <h4 class="m-0">Laporan Laba Rugi Detail</h4>
        </div>
    </div>
</div>
...
<?php
$a=pg_fetch_array(pg_query($conn,"SELECT * FROM keu_akun_bulan_labarugi WHERE id_bulan='$id_bulan' AND tahun='$tahun'"));
if($a['id']!=''){
    $sql="UPDATE keu_akun_bulan_labarugi SET saldo='$laba', created_at='$waktu_sekarang' WHERE id='$a[id]'";
}
else{
    $sql="INSERT INTO keu_akun_bulan_labarugi (id_bulan, tahun, saldo, created_at) VALUES ('$id_bulan', '$tahun', '$laba', '$waktu_sekarang')";
}
pg_query($conn,$sql);
?>
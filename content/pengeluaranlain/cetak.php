...
<html>
	...
	<body onload="myFunction()">
        ...
        <div class="content-body">
            <table>
                <tr style="height:30px"><td width="150px">AKUN BANK/KAS</td><td width="10px">:</td><td><?php echo "$d[nomor_akun_asal] - $d[nama_akun_asal]";?></td></tr>
                <tr style="height:30px"><td>AKUN DEBET</td><td>:</td><td><?php echo "$d[nomor_akun_tujuan] - $d[nama_akun_tujuan]";?></td></tr>

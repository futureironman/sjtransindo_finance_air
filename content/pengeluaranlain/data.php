        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Pengeluaran Lain</li>
                </ol>
            </nav>
            <h4 class="m-0">Pengeluaran Lain</h4>
        </div>
        <a href="tambah-pengeluaranlain"><button type="button" class="btn btn-info ml-3"><i class="fa fa-plus"></i> Tambah</button></a>
    </div>
</div>
                    ...
                    <tbody>
                        ...
                        while($r=pg_fetch_array($tampil)){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit-pengeluaranlain-<?php echo $r['uid'];?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></button></a>
...
<script type="text/javascript" src="addons/js/pengeluaranlain.js"></script>
<?php
break;

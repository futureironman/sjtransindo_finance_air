...
<html>
	...
	<body onload="myFunction()">
        ...
        <div class="content-body">
            <table>
                <tr style="height:30px"><td width="150px">DARI AKUN</td><td width="10px">:</td><td><?php echo "$d[nomor_akun_asal] - $d[nama_akun_asal]";?></td></tr>
                <tr style="height:30px"><td>KE AKUN</td><td>:</td><td><?php echo "$d[nomor_akun_tujuan] - $d[nama_akun_tujuan]";?></td></tr>

...
<div class="container-fluid page__heading-container">
    <div class="page__heading d-flex align-items-center">
        <div class="flex">
            ...
            <h4 class="m-0">Jurnal Penyesuaian</h4>
        </div>
        <a href="tambah-jurpen"><button type="button" class="btn btn-info ml-3"><i class="fa fa-plus"></i> Tambah</button></a>
    </div>
</div>
                    ...
                    <tbody>
                        ...
                        while($r=pg_fetch_array($tampil)){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit-jurpen-<?php echo $r['uid'];?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></button></a>
...
<script type="text/javascript" src="addons/js/jurpen.js"></script>
<?php
break;

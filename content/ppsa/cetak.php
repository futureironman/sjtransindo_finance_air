...
<html>
	...
	<body onload="myFunction()">
        ...
        <div class="content-body">
            <table>
                <tr style="height:30px"><td width="150px">AKUN KAS/BANK</td><td width="10px">:</td><td><?php echo "$d[nomor_akun_asal] - $d[nama_akun_asal]";?></td></tr>
                <tr style="height:30px"><td>AKUN CUSTOMER</td><td>:</td><td><?php echo "$d[nomor_akun_tujuan] - $d[nama_akun_tujuan]";?></td></tr>

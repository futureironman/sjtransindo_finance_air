        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Pelunasan Piutang Saldo Awal</li>
                </ol>
            </nav>
            <h4 class="m-0">Pelunasan Piutang Saldo Awal</h4>
        </div>
        <a href="tambah-ppsa"><button type="button" class="btn btn-info ml-3"><i class="fa fa-plus"></i> Tambah</button></a>
    </div>
</div>
                    ...
                    <?php
                        ...
                        while($r=pg_fetch_array($tampil)){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit-ppsa-<?php echo $r['uid'];?>"><button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></button></a>
...
<script type="text/javascript" src="addons/js/ppsa.js"></script>
<?php
break;

        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Buku Besar Bulanan</li>
                </ol>
            </nav>
            <h4 class="m-0">Laporan Buku Besar Bulanan</h4>
        </div>
    </div>
</div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover" style="width:100%">
                    ...
                    <?php
                        ...
                        $no=1;
                        //$tampil=pg_query($conn,"SELECT a.*, b.nama FROM keu_akun_log a, keu_akun_status b WHERE a.created_at BETWEEN '$tanggal_awal 00:00:00' AND '$tanggal_akhir 23:59:59' AND a.uid_akun='$uid_akun' AND a.id_status=b.id and deleted_at is null ORDER BY a.created_at ASC, id ASC");
...
$(".btnCetak").click(function() {
    var id = this.id;
    window.open("cetak-lapbukubesar?uid_akun=<?php echo $uid_akun;?>&id_bulan=<?php echo $id_bulan;?>&tahun=<?php echo $tahun;?>" + id, "popupWindow", "width=600,height=600,scrollbars=yes");
});
</script>
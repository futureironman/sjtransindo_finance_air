        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="penjualan">Penjualan Terbaru</a></li>
                    ...
                    <table class="table table-bordered mb-5">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td class="text-right"><input type="text" class="form-control money text-right" name="jumlah_bayar" id="jumlah_bayar"></td>
                            </tr>
                            <tr>

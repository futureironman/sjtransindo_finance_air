        ...
        <div class="flex">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Pembelian Import</li>
                </ol>
            </nav>
            <h4 class="m-0">Pembelian Import</h4>
        </div>
    </div>
</div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <br>
                <a href="sinkron-invoice-pembelianimport?<?php echo "tanggal_awal=$tanggal_awal&tanggal_akhir=$tanggal_akhir";?>" class="btn btn-danger"><i class="material-icons">sync</i> SINKRONISASI INVOICE DENGAN AKUN HUTANG SUPPLIER</a>
            </div>
        </div>
    </div>
</div>

    ...
    <div class="card card-form">
        <div class="row no-gutters">
            ...
            <p><strong class="headings-color">No Bukti</strong></p>
                    <h3 style="color: red !important; font-weight: bold;"><?php echo $no_bukti ?></h3>
            </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-8">
                        <select name="uid_supplier" id="id_supplier" class="form-control select2" required>
                            ...
                            <?php
                                $tampil = pg_query($conn, "SELECT a.uid as uid, a.nama FROM master_supplier a, keu_akun b WHERE a.uid=b.uid_data and a.id_divisi='$_SESSION[divisi]' ORDER BY a.nama");
                ...
                for (var a = 0; a < response.data.length; a++) {
                    if ( response.data) {
                        $(".data-pembelian tbody").append("<tr>" +
                            ...
                            "<td>" +  response.data[a]["tanggal_pembelian"] + "</td>" +
                            ...
                            "<td class='text-right'>" + number_format( parseInt(response.data[a]["total"])) + "<input type=\"hidden\" class=\"form-control\" name=\"sisa_bayar_"+ no +"\" value=\""+ response.data[a]["sisa_bayar"]+"\"/></td>" +

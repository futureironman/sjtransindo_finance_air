    ...
    <div class="card">
        ...
        <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover" style="width:100%" id="example">
                            ...
                            $grand_total = 0;
                            $grand_total_bayar = 0;
                            $tampil = pg_query($conn, "SELECT * from keu_buka_faktur where deleted_at is NULL and tanggal BETWEEN '$tanggal_awal 00:00:00' AND '$tanggal_akhir 23:59:59' and uid_akun='$_GET[uid]'");
